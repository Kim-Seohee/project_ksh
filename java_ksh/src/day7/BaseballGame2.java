...
public class BaseballGame2 {
	 ...
	 * 메소드명: contains
	 * 설명: [1,2,3,4,5] 배열에서 처음부터 3개 중에서 5가 있는지 없는지 확인 => X
	 *      [1,2,3,4,5] 배열에서 처음부터 5개 중에서 5가 있는지 없는지 확인 => O
	 * */
	...
	/* 기능: 배열 arr1과 배열 arr2에서 같은 위치의 숫자를 비교하여 같은 숫자의 개수를 알려주는 메소드
	 ...
	 * 매개변수: ball과 strike => int ball int strike
	 * 리턴타입: 없음
	 * 메소드명: printResult
	 * */
